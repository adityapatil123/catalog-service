...
def translate_item_descriptor(item_descriptor, target_lang):
    ...
    if "short_desc" in item_descriptor:
        item_descriptor["short_desc"] = ts.get_transliterated_text(item_descriptor["short_desc"], target_lang=target_lang)
    if "long_desc" in item_descriptor:
        item_descriptor["long_desc"] = ts.get_transliterated_text(item_descriptor["long_desc"], target_lang=target_lang)
...
def translate_provider_descriptor(provider_descriptor, target_lang):
    ...
    if "short_desc" in provider_descriptor:
        provider_descriptor["short_desc"] = ts.get_transliterated_text(provider_descriptor["short_desc"],
                                                                       target_lang=target_lang)
    if "long_desc" in provider_descriptor:
        provider_descriptor["long_desc"] = ts.get_transliterated_text(provider_descriptor["long_desc"],
                                                                      target_lang=target_lang)
